...
had with a custom one that's highly configurable. 

Right now it supports Noelle's Role 1.6.3-h1.3, Stupid Express 0.7.1, Kin's Wathe 1.5.5-fix, Starry Express 1.3.1. Of course 
