...
public abstract class PlayerBodyNullCheckMixin {
    ...
    private boolean wyspiaexpress$nullCheckMoodComponent(PlayerMoodComponent instance, Operation<Boolean> original) {
