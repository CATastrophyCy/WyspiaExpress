...
public class RolesConfigModel {
    ...
    Valid items:\s
        ...
        CROWBAR, BODY_BAG, BLACKOUT, NOTE, TAPE, FAKE_KNIFE, DELUSION_VIAL, DEFENSE_VIAL, 
        ROLE_MINE, MASTER_KEY, FAKE_REVOLVER, PAN, COOKED_PORKCHOP, COOKED_CHIKEN, 
        COOKED_BEEF, PILL, MEDICAL_KIT, ACID_BARREL, HUNTING_KNIFE, KNOCKOUT_DRUG, 
        DREAM_IMPRINT, BLOWGUN, POISON_INJECTOR, FUN_BOX, MEGAPHONE
    """)
